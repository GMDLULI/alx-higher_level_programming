...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        """create a square
        Args:
            size: length of a size of square
            position: where the square is (coodinates)
        """
        self.size = size
    ...
    def size(self):
        ...
        """The propety of size as the len of the side of Square
        Raises:
    ...
    def position(self, value):
        """set the position of the this Square
